        ...
        return ( 
            ...
            <CardColumns>
                ...
                <CardTitle className="trip-title">
                    ...
                    <CardSubtitle className="total-cost">
                        <span className="span-length">Trip Length:</span> {length}
                    </CardSubtitle>
                    ...
                    <Collapse isOpen={ toggle }>
                        ...
                        <CardText className="expenses"> <span className="current-expenses-span">Current Expenses:</span><br/> </CardText>
                         <TripCardExpenses key={tripId} tripExpenses = {expenses} /> 
                        </Card>
                    </Collapse>
                    ...
                    <Collapse isOpen={ toggleUpdate }>
                        <Card>  
                            <AddExpenseItem key= {budget} expenseList= {tripExpenses} setExpenseList={setTripExpenses} totalCost={currentCost} setTotalCost={setCurrentCost}/>
                            <ExpenseList key= {tripId} expenseList= {tripExpenses} setExpenseList={setTripExpenses}/>
